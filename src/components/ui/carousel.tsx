...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      <li
        ref={slideRef}
        className="flex flex-1 flex-col justify-end relative text-center opacity-100 transition-all duration-300 ease-in-out w-[calc(100vw-2rem)] h-[calc(100vw-2rem)] sm:w-[40vmin] sm:h-[40vmin] mx-[0.313rem] first:ml-0 last:mr-0 z-10"
...
export function Carousel({ slides }: CarouselProps) {
  ...
  return (
    <div
      className="relative w-[calc(100vw-2rem)] h-[calc(100vw-2rem+2.5rem+2rem)] sm:w-[40vmin] sm:h-[calc(40vmin+2.5rem+2rem)] mx-auto"
    ...
    >
      ...
      <div className="absolute flex justify-center w-full bottom-1 gap-5">
        <CarouselControl
          type="previous"
