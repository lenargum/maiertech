...
const Header = () => {
  ...
  return (
    <header className="max-w-[100vw] md:container md:mx-auto fixed top-0 left-0 right-0 z-10 p-4 md:p-0 md:pt-5">
      <HoverBorderGradient containerClassName="rounded-full w-full" className="flex justify-between items-center gap-8 py-4 px-5 md:p-5 md:pl-8 dark:border-[#1A1A1A] h-20 bg-white dark:bg-black backdrop-blur-[10px]">
        <div className="flex items-center">
          <Link to="/" className="flex items-center">
            <HeaderLogo className="h-[28px] md:h-[41px]" />
          </Link>
        </div>
      ...
      {isMobileMenuOpen && (
        <div className="flex md:hidden fixed z-50 inset-0 h-screen w-screen bg-white dark:bg-black backdrop-blur-[10px] flex-col justify-between items-center gap-10 p-8"
