...
const HistorySection: React.FC = () => {
    return (
        <section className="container mx-auto flex flex-col lg:flex-row justify-between items-center gap-15 py-20 lg:py-30 relative">
            ...
            <div className="flex justify-center items-center flex-grow max-h-[28.75rem]">
                <img src={historyImage} alt="History" className="max-w-[44rem] w-full aspect-square max-h-[28.75rem] lg:max-h-none" />
            </div>
        </section>
    )
}
